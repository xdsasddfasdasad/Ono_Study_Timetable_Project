...
export default function FloatingAgentButton() {
    ...
    // This is efficient because this component will only re-render if `setIsAgentOpen` changes,
    ...
    const handleOpenAgent = () => {
        // It dispatches the state update to our global context.
        setIsAgentOpen(true);
    };

    return (
        // 3. The JSX for rendering the button.
        // The Zoom component from MUI provides a nice "pop-in" animation.
        <Zoom in={true} style={{ transitionDelay: '500ms' }}>
            {/* The Tooltip improves accessibility and user experience by showing a label on hover. */}
            <Tooltip title="AI Assistant" placement="left">
                <Fab 
                    ...
                    sx={{
                        ...
                        zIndex: 1301 // A high z-index ensures it floats above most other UI elements.
                    }}
                >
